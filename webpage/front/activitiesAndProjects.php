...
<div class="entry">
    ...
    <div class="par">
        ...
        <h5>Engineering club and project at California State University Fullerton, California, USA</h5>
        Took part in the design and construction of an UAS for a competition. I focused mainly on programming using python in order to achieve autonomous navigation. My program interfaced with the autopilot and provided new waypoints when necessary.
    </div>
</div>
...
<div class="entry">
    ...
    <div class="par">
        ...
        <h5>Theater group at Chalmers University of Technology, Gothenburg, Sweden</h5>
        Treasurer for two years, yearly revenue was approximately 125.000 SEK. Then another position as officer for a year. During my last year with the club I lead the group that focused on construction of the stage and the prop used in the show. We were 5 person in that group.
    </div>
</div>
